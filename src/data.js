...
export const PROJECTS_DATA = [
  ...
  },
  {
    ...
    modal: {
      content: [
      "Proyecto universitario desarrollado para el curso de Estructuras de Datos Avanzadas.",
      "El objetivo del proyecto fue diseñar una estructura de datos capaz de almacenar y consultar información de millones de ciudadanos simulando una base de datos nacional, sin utilizar un sistema gestor de bases de datos.",
      "Como solución, se implementó un B+ Tree en C++ capaz de manejar más de 33 millones de registros generados de manera aleatoria, permitiendo realizar inserciones y búsquedas eficientes por clave. La estructura incluye persistencia en disco, de modo que la información almacenada puede ser recuperada en memoria cada vez que el programa se inicia.",
      "Mi rol en el proyecto fue la implementación completa del sistema, así como el testeo de rendimiento y el análisis de complejidad tanto temporal como espacial. El principal reto afrontado fue el manejo de memoria a gran escala y el balance entre rendimiento y almacenamiento al trabajar con volúmenes de datos elevados.",
      ]
    },
  },
  {
    ...
    modal: {
      ...
      content: [
        "Proyecto universitario desarrollado para el curso de Programación Competitiva, basado en un caso simulado de criminalística.",
        "El objetivo fue desarrollar un sistema capaz de identificar posibles sospechosos a partir de la comparación de una muestra de ADN con una base de datos de secuencias genéticas proporcionadas en formato CSV.",
